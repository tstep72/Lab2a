...
public class TestInfografika {
    public static void main(String[] args) {
        ...
        Infografika inf1 = new Infografika(exItem);

        System.out.println("Infografika:\ntytul: " + inf1.tytul
                                        + "\nadres strony: " + inf1.adresStrony
                                        + "\nadres grafiki: " + inf1.adresGrafiki
                                        + "\nadres miniaturki: " + inf1.adresMiniaturki
                                        + "\nrozmiary: " + inf1.szerokosc + "x" + inf1.wysokosc + "\n");
    }
}
